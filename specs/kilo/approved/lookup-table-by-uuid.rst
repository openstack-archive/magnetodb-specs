...
2. List table response will additionally contain table id and name
3. Describe table will contatin table id
4. Pagination will be available by table name, however exclusive_start_table_id field will be added to list request body as alternative to exclusive_start_table_name and last_evaluated_table_id to list response body
