...
4. Pagination will be available by table name, however exclusive_start_table_id field will be added to list request body as alternative to exclusive_start_table_name
